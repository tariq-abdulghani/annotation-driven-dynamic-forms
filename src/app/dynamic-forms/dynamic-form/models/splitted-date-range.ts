...
export function splittedDateRangeControl(metaData: {
    ...
    return function (target: any, propertyKey: string) {
      ...
      const endDateMeta ={
        ...
        formControl: new FormControl(metaData.startDate, maxDateValidator(metaData.endDate)),
      ...
      const endDateGetter = ()=>{
       ...
       const startDateMeta ={
        ...
        maxDate: metaData.endDate,
        controlType: ControlTypes.Date,
        formControl: new FormControl(metaData.startDate, [minDateValidator(metaData.startDate),maxDateValidator(metaData.endDate)]),
        width:metaData.width,
        style: metaData.style,
        class:metaData.class,
      }
      ...
      startDateMeta.formControl.valueChanges.subscribe(n => {
        ...
        endDateMeta.formControl.setValidators([minDateValidator(endDateMeta.minDate), maxDateValidator(metaData.endDate)]);
